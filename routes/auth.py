...
def dashboard():
    ...
    # Get counts for external servers
    ...
    for server in external_servers:
        if server.last_status == 'online':
            ext_server_status_counts['active'] += 1
        elif server.last_status == 'offline':
            ext_server_status_counts['error'] += 1
        else:
            ext_server_status_counts['pending'] += 1
    ...
    return render_template('dashboard.html',
                         ...
                         ext_server_status_counts=ext_server_status_counts,
                         servers=servers,
                         domains=domains,
